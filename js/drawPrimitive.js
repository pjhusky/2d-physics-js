...
var MyDrawPrimitive = (function (exports) {
    ...
    let setupCircle = function setupCircleFn( center_point, radius, num_segments ) {
        ...
        // TODO: just return setupPolygon() with the calculated vertex positions !!!
        ...
        // //const [ pivot_x, pivot_y ] = [ center_point[0], center_point[1] ];
        // const pivot_x = center_point[0];
        // const pivot_y = center_point[1];
        // circle.pivot.set( pivot_x, pivot_y );
        // circle.position.set( pivot_x, pivot_y );
        
        // circle.drawMode = PIXI.DRAW_MODES.TRIANGLE_FAN;
    ...
    let setupPolygon = function setupPolygonFn( vertex_positions, texture_coords/*, indices*/ ) {
        ...
        //polygon.drawMode = PIXI.DRAW_MODES.TRIANGLE_STRIP;
